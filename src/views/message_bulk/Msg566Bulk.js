...
import {load, searchVessels, send} from "../../apis/message_bulk/566.js";

export default function Msg566Bulk() {
  const onFocus = () => {};
  ...
  React.useEffect(() => {
    document.title = "Xin số định danh cho hàng rời";
