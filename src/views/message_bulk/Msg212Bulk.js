...
import {load, searchVessels, send} from "../../apis/message_bulk/212.js";

export default function Msg212Bulk() {
  const onFocus = () => {};
  ...
  React.useEffect(() => {
    document.title = "Hàng rời được xếp dỡ xuống cảng kho bãi";
  ...
  return (
    <>
      ...
      >
        <Col span={6}>
          <Card
            title={"[212] \r\n HÀNG RỜI ĐƯỢC XẾP DỠ XUỐNG CẢNG/KHO/BÃI"}
