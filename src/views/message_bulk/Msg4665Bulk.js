...
import { load, searchVessels, send } from "../../apis/message_bulk/4665.js";
import VesselSelect from "../../global_component/Modal/VesselSelect.js";
import { Filter, filterType } from "../../global_component/Filter/index.jsx";

export default function Msg4665Bulk() {
  const onFocus = () => { };
  ...
  React.useEffect(() => {
    document.title = "Hiệu chỉnh hàng rời Getin";
  ...
  return (
    <>
      ...
      >
        <Col span={6}>
          <Card
            title={"[4665] \r\n HIỆU CHỈNH THÔNG TIN GETIN CHO HÀNG RỜI"}
