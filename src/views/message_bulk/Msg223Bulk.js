...
import { load, searchVessels, send } from "../../apis/message_bulk/223.js";
import VesselSelect from "../../global_component/Modal/VesselSelect.js";
import { Filter, filterType } from "../../global_component/Filter/index.jsx";

export default function Msg223Bulk() {
  const onFocus = () => { };
  ...
  React.useEffect(() => {
    document.title = "Hàng rời đủ điều kiện qua KVGS";
  ...
  return (
    <>
      ...
      >
        <Col span={6}>
          <Card
            title={"[223] \r\n HÀNG RỜI ĐỦ ĐIỀU KIỆN QUA KVGS"}
