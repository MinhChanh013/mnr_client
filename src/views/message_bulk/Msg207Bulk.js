...
import {load, searchVessels, send} from "../../apis/message_bulk/207.js";

export default function Msg207Bulk() {
  const onFocus = () => {};
  ...
  React.useEffect(() => {
    document.title = "Xác nhận getin hết hàng";
