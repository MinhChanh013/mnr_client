...
import {load, searchVessels, send} from "../../apis/message_bulk/421CSHT.js";

export default function Msg421BulkCSHT() {
  const onFocus = () => {};
  ...
  React.useEffect(() => {
    document.title = "[CSHT] Gửi Getout hàng rời có TKHQ";
