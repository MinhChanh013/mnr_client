...
import { load, searchVessels, send } from "../../apis/message_bulk/441.js";
import VesselSelect from "../../global_component/Modal/VesselSelect.js";

export default function Msg441Bulk() {
  const onFocus = () => { };
  ...
  React.useEffect(() => {
    document.title = "Gửi Getout hàng rời không TKHQ";
  ...
  return (
    <>
      ...
      >
        <Col span={6}>
          <Card
            title={"[441] \r\n GỬI GETOUT HÀNG RỜI QUA KVGS KHÔNG TKHQ"}
